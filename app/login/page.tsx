...
import { saveUserSession, completeOnboarding } from '@/lib/auth'; // Importing completeOnboarding to simulate existing user scenario
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Assume existing users have finished onboarding
    completeOnboarding();
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                type="email"
                required
                className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all placeholder:text-slate-600"
